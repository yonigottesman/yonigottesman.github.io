...
excerpt: "In this post, I aim to provide a simplified understanding of diffusion models by drawing parallels with variational autoencoders (VAEs), which are also latent variable models. "
